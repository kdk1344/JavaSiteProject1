						...
						<div id="main">
							<div class="wrapper">
								<div class="inner">
									...
									<!-- Table -->
									<h3><a href="/board02/sangdam" class="button small">목록 보기</a></h3>
									<div class="content">
										<div class="form">
											<form method="post" action="/board02/register" id="registForm" name="registForm" enctype="multipart/form-data">
												<div class="fields">
													<div class="field">
														<h4>제목</h4>
